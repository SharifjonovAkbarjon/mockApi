...

      {
        ...
        <div className='bg-[#00001148]  fixed h-[100%] py-4 px-[100px] w-[100%]'>
          <div className=' w-[400px] top-0 left-0'>
            <form className='top-0 left-0 flex flex-col gap-3 bg-white' onSubmit={handleUpdateCategory} action="">
      ...
      <div className='flex flex-wrap gap-[20px] '>
        {
          data?.map((category) => (
            <div className='gap-4' key={category.id}>
              <div className='bg-green-400 w-[250px]  rounded-[20px] py-[20px] px-[20px] text-center flex flex-col gap-1'>
                ...
                <h5 className='text-yellow-200'><span className='text-green-300'>Fname</span> :{category.fname}</h5>
